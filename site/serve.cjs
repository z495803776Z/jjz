...
const ROOT = 'C:/Users/ASUS/Documents/Codex/2026-06-26/superpowers-plugin-superpowers-openai-curated/site';
const PORT = 8888;
const DEEPSEEK_API_KEY = 'sk-1e2b2ef42ab64c3d8271a74d2cb92990';
...
http.createServer(async (req, res) => {
  ...
  if (url === '/api/deep-reading' && req.method === 'POST') {
    try {
